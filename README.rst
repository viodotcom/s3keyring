...
.. image:: https://circleci.com/gh/InnovativeTravel/python-project-template.svg?style=svg
    :target: https://circleci.com/gh/InnovativeTravel/python-project-template
...
#. Set up project directory and virtualenv. You need to replace `coolproject` below with the actual name of your project::

    MY_PROJECT=coolproject
    mkdir $MY_PROJECT
    cd $MY_PROJECT
    virtualenv venv
    . venv/bin/activate
    git clone git@github.com:InnovativeTravel/python-project-template.git $MY_PROJECT
    cd $MY_PROJECT

#. Edit the metadata file ``my_project/metadata.py`` to correctly describe your project.
...
#. Initialize the git repo, update submodules, and install dev requirements::
        ...
        cd docs/source
        rmdir _themes
        git submodule add https://github.com/mitsuhiko/flask-sphinx-themes _themes
